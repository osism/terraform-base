...
resource "openstack_networking_router_v2" "router" {
  ...
  depends_on          = [openstack_networking_subnet_v2.subnet_management, openstack_networking_secgroup_v2.security_group_node, openstack_networking_secgroup_v2.security_group_management]
}
